...
function averagemisedvotes(array) {
    ...
    console.log(sorted.map(m => m.missed_votes_pct));
    ...
    for (let i = 0; i < sorted.length; i++) {
        if (i <= sorted.length * 0.1) {
            ...
            if (sorted[i].missed_votes_pct == sorted[i + 1].missed_votes_pct) {
...
function averagemisedv(array) {
    ...
    console.log(secondsorted.map(m => m.missed_votes_pct));
    ...
    for (let i = 0; i < secondsorted.length; i++) {
        if (i <= secondsorted.length * 0.1) {
            ...
            if (secondsorted[i].missed_votes_pct == secondsorted[i + 1].missed_votes_pct) {
...
function createsecondtable(array) {
    ...
    for (let i = 0; i < array.length; i++) {
        ...
        celdavotes.innerHTML = (array[i].missed_votes_pct);
